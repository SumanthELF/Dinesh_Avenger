...
public class Flipkart1 {
	...
	public static void searchAndAddProduct(String productName) throws InterruptedException {
		...
		explicitwait.until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("//div[contains(text(), '" + productName + "')]")));
		Thread.sleep(3000);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		List<WebElement> prices = driver.findElements(By
				.xpath("(//div[contains(@style, 'box-shadow') ]//span[contains(text(), '*')]) [position() mod 2 =0]"));
		...
		driver.findElement(By.xpath("//div[text()='Remove Item']/..//div[text()='Remove']"));
	}
}
